package uv.listi.sicae_usuarios.security;
...
public class JwtUtil {
    ...
    public String generarToken(Integer idUsuario, Integer idRol, String usuario, String claveUsuario) {
        return Jwts.builder()
                .subject(usuario)
                .claim("idUsuario", idUsuario)
                .claim("idRol", idRol)
                .claim("usuario", usuario)
                .claim("claveUsuario", claveUsuario)
                .issuedAt(new Date())
                .expiration(Date.from(Instant.now().plusSeconds(3600 * 8)))
                .signWith(llave())
                .compact();
    }
